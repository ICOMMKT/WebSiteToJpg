 ...
 * 
 * Modified By: Jr Ilheu
 * https://github.com/jrilheu
 * 
 * Adapted to render under an Iframe element
 * 
 * Released under the MIT license
 *
 * Date: 2015-11-21T23:41:42.241Z
 */
...
(function (factory) {
    ...
    $.extend(prototype, {
        ...
        start: function () {
            ...
            //getImageSize(this, $.proxy(function (naturalWidth, naturalHeight) {
            var naturalWidth = this.$element.parent().width();
            var naturalHeight = this.$element.parent().height();
            this.image = {
    ...
    $.extend(prototype, {
        initPreview: function () {
            ...
            this.$viewBox.html(this.$clone.clone());

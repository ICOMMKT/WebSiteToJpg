...
{
    public class IcommktAuthenticationHandler : AuthenticationHandler<IcommktAuthenticationOptions>
    {
        private const string TokenEndpoint = "https://Icommkt.com/oauth2/access_token";
        private const string GraphApiEndpoint = "https://api.Icommkt.com/v2/users/self";
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new IcommktAuthenticatedContext(Context, user, accessToken);
                context.Identity = new ClaimsIdentity(
                    new[]
                    {
                        ...
                        new Claim("urn:icommkt:id", context.Id, XmlSchemaString, Options.AuthenticationType),
                        new Claim("urn:icommkt:name", context.Name, XmlSchemaString, Options.AuthenticationType)
                    },
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                string authorizationEndpoint =
                    "https://Icommkt.com/oauth2/authenticate" +
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new IcommktReturnEndpointContext(Context, model);
